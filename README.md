...
| [`spec-github-actions`](examples/spec-github-actions/) | async spec interview in a Discussion → build-ready spec | GitHub | GitHub | Discussions | `@flue-spec` mention → `on: discussion_comment` | GitHub Actions | ✅ complete |
...
| [`assistant-teams-daytona`](examples/assistant-teams-daytona/) | do a task in a sandbox, reply in-conversation | Teams | — | Daytona sandbox (per-conversation) | Teams Bot Connector webhook | any container host | ✅ complete |
